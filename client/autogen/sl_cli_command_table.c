...
static const sl_cli_command_info_t cli_cmd__get_print_package_info = \
  SL_CLI_COMMAND(cli_get_print_package_info,
                 "Get the print setting",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__set_print_package_info = \
  SL_CLI_COMMAND(cli_set_print_package_info,
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "get_print_package_info", &cli_cmd__get_print_package_info, false },
  { "set_print_package_info", &cli_cmd__set_print_package_info, false },
